...
setuptools.setup(
    ...
    description="Algorithms for computing or learning equilibria multi-objective games",  # Short tagline.
    ...
    install_requires=['scipy']  # Install other dependencies if any.
)
